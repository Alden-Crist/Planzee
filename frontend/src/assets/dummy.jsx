...
export const INPUTWRAPPER =
  "flex items-center border border-teal-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-teal-500 focus-within:border-teal-500 transition-all duration-200";
export const BUTTON_CLASSES =
  "w-full bg-gradient-to-r from-teal-500 to-teal-200 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2";

// PROFILE CSS
export const INPUT_WRAPPER =
  "flex items-center border border-teal-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-teal-500 focus-within:border-teal-500 transition-all duration-200";
export const FULL_BUTTON =
  "w-full bg-gradient-to-r from-teal-500 to-teal-600 text-white py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2";
export const SECTION_WRAPPER =
  "bg-white rounded-xl shadow-sm border border-teal-100 p-6";
export const BACK_BUTTON =
  "flex items-center text-gray-600 hover:text-teal-600 mb-8 transition-colors duration-200";
...
export const SIDEBAR_CLASSES = {
  desktop:
    "hidden md:flex flex-col fixed h-full w-20 lg:w-64 bg-white/90 backdrop-blur-sm border-r border-teal-100 shadow-sm z-20 transition-all duration-300",
  mobileButton:
    "absolute md:hidden top-25 left-5 z-50 bg-teal-600 text-white p-2 rounded-full shadow-lg hover:bg-teal-700 transition",
  mobileDrawerBackdrop: "fixed inset-0 bg-black/40 backdrop-blur-sm",
  mobileDrawer:
    "absolute top-0 left-0 w-64 h-full bg-white/90 backdrop-blur-md border-r border-teal-100 shadow-lg z-50 p-4 flex flex-col space-y-6",
};

export const LINK_CLASSES = {
  base: "group flex items-center px-4 py-3 rounded-xl transition-all duration-300",
  active:
    "bg-gradient-to-r from-teal-50 to-teal-50 border-l-4 border-teal-500 text-teal-700 font-medium shadow-sm",
...
export const PRODUCTIVITY_CARD = {
  container: "bg-teal-50/50 rounded-xl p-3 border border-teal-100",
  header: "flex items-center justify-between mb-2",
  label: "text-xs font-semibold text-teal-700",
  badge: "text-xs bg-teal-200 text-teal-700 px-2 py-0.5 rounded-full",
  barBg: "w-full h-2 bg-teal-200 rounded-full overflow-hidden",
  barFg: "h-full bg-gradient-to-r from-teal-300 to-blue-400 animate-pulse",
};

export const TIP_CARD = {
  container:
    "bg-gradient-to-r from-teal-50 to-teal-100 rounded-xl p-4 border border-teal-100",
  iconWrapper: "p-2 bg-teal-100 rounded-lg",
...
export const BUTTONCLASSES =
  "w-full bg-gradient-to-r from-blue-400 to-teal-500 text-white text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center justify-center gap-2";
...
export const getPriorityColor = (priority) => {
  const colors = {
    ...
    medium: "border-teal-500 bg-teal-50/50 text-teal-600",
    high: "border-teal-800 bg-teal-50/50 text-teal-800",
  };
  return (
...
export const getPriorityBadgeColor = (priority) => {
  const colors = {
    ...
    medium: "bg-teal-100 text-teal-900",
    high: "bg-teal-300 text-teal-900",
  };
...
export const ADD_BUTTON =
  "flex items-center gap-2 bg-gradient-to-r from-teal-400 to-cyan-500 text-white px-4 py-2 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 w-full md:w-auto justify-center text-sm md:text-base";
export const STATS_GRID =
  "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-4 md:mb-6";
export const STAT_CARD =
  "p-3 md:p-4 rounded-xl bg-white shadow-sm border border-teal-100 hover:shadow-md transition-all duration-300 min-w-0";
...
export const EMPTY_STATE = {
  wrapper:
    "p-6 bg-white rounded-xl shadow-sm border border-teal-100 text-center",
  iconWrapper:
    "w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4",
  btn: "px-4 py-2 bg-gradient-to-r from-blue-400 to-teal-500 text-white rounded-lg text-sm font-medium",
};
...
export const SELECT_CLASSES =
  "px-3 py-2 border border-teal-100 rounded-lg focus:ring-2 focus:ring-teal-500 md:hidden text-sm";
export const TABS_WRAPPER =
  "hidden md:flex space-x-1 bg-teal-50 p-1 rounded-lg";
export const TAB_BASE =
  "px-3 py-1.5 rounded-lg text-xs font-medium transition-all";
export const TAB_ACTIVE = "bg-white text-teal-700 shadow-sm border";
...
export const CT_CLASSES = {
  ...
  sortBox:
    "flex items-center justify-between bg-white p-2 md:p-3 rounded-xl shadow-sm border border-teal-100 w-full md:w-auto",
  filterLabel: "flex items-center gap-2 text-gray-700 font-medium",
  select:
    "px-2 py-1 md:px-3 md:py-2 border border-teal-100 rounded-lg focus:ring-2 focus:ring-teal-500 md:hidden text-xs md:text-sm",
  ...
  emptyState:
    "p-4 md:p-8 bg-white rounded-xl shadow-sm border border-teal-100 text-center",
  emptyIconWrapper:
    "w-12 h-12 md:w-16 md:h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4",
...
export const layoutClasses = {
  ...
  sortBox:
    "flex items-center justify-between bg-white p-3 rounded-xl shadow-sm border border-teal-100 w-full md:w-auto",
  select:
    "px-3 py-2 border border-teal-100 rounded-lg focus:ring-2 focus:ring-teal-500 md:hidden text-sm",
  ...
  addBox:
    "hidden md:block p-5 border-2 border-dashed border-teal-200 rounded-xl hover:border-teal-400 transition-colors cursor-pointer mb-6 bg-teal-50/50 group",
  emptyState:
    "p-8 bg-white rounded-xl shadow-sm border border-teal-100 text-center",
  emptyIconBg:
    "w-16 h-16 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4",
  emptyBtn:
    "px-4 py-2 bg-teal-100 hover:bg-teal-200 text-teal-700 rounded-lg text-sm font-medium transition-colors",
};
...
export const TI_CLASSES = {
  wrapper:
    "group p-4 sm:p-5 rounded-xl shadow-sm bg-white border-l-4 hover:shadow-md transition-all duration-300 border border-teal-100",
  leftContainer: "flex items-start gap-2 sm:gap-3 flex-1 min-w-0",
  completeBtn:
    "mt-0.5 sm:mt-1 p-1 sm:p-1.5 rounded-full hover:bg-teal-100 transition-colors duration-300",
  ...
  subtasksContainer:
    "mt-3 sm:mt-4 space-y-2 sm:space-y-3 bg-teal-50/30 p-2 sm:p-3 rounded-lg border border-teal-100",
  progressBarBg: "h-1.5 bg-teal-100 rounded-full overflow-hidden",
  progressBarFg:
    "h-full bg-gradient-to-r from-blue-400 to-teal-500 transition-all duration-300",
  rightContainer: "flex flex-col items-end gap-2 sm:gap-3",
  menuButton:
    "p-1 sm:p-1.5 hover:bg-teal-100 rounded-lg text-gray-500 hover:text-teal-700 transition-colors duration-200",
  menuDropdown:
    "absolute right-0 mt-1 w-40 sm:w-48 bg-white border border-teal-100 rounded-xl shadow-lg z-10 overflow-hidden animate-fadeIn",
