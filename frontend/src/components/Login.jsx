...
const Login = ({ onSubmit, onSwitchMode }) => {
  ...
  useEffect(() => {
    ...
    const userId = localStorage.getItem("userId"); // fixed typo
    if (token) {
      (async () => {
        try {
  ...
  return (
    <div className="max-w-md bg-white w-full shadow-lg border border-teal-100 rounded-xl p-8">
      ...
      <div className="mb-6 text-center">
        ...
        <p className="text-gray-500 text-sm mt-1">
          Sign in to continue to Planzee
        </p>
      </div>
